VALIDATION FOR SPICE3F5 MODEL FROM IBIS MODEL(S) HSTL_II_F_HR_IN50
********************************************************************************
*
...
.INCLUDE C:\Jeonghyun\GIT\PMOD2BNC\IBIS\output2.cir
...
* BUFFER
XIBIS NINP NOUT NVDD NVSS NENB HSTL_II_F_HR_IN50_TYP
