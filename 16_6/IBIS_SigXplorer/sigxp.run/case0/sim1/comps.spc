...
.node_param 3 name=DESIGN.IO2.1  vlo_max=0.8 vhi_min=2 print refnode cycles=(1 ) 
...
bdrvr 18 3 19 23 22 20 21 Model=LVCMOS33_F_16_HR_Typ_27degC File=ibis_models.inc
...
.node_param 3 name=DESIGN.IO1.1  vlo_max=0.8 vhi_min=2 print  cycles=(1 ) 
*** End of node printing ***
